        ...
        <div id="page" class="hfeed site">
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse navbar-ex1-collapse">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">特点 <i class="fa fa-angle-double-down"></i></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="elements.ftl">UI Elements</a></li>
                                        <li><a href="buttons.ftl">Buttons</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="blog.ftl">Blog: Left Sidebar</a></li>
                                        <li><a href="../blog2.ftl">Blog: Right Sidebar</a></li>
                                        <li><a href="blog3.ftl">Blog: 3 Columns</a></li>
                                        <li><a href="blog4.ftl">Blog: 2 Columns</a></li>
                                        <li><a href="../post.html">Post: Left Sidebar</a></li>
                                        <li><a href="../article.ftl">Post: Right Sidebar</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
            ...
            <header class="archive-header">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <h4 class="archive-title">UI Elements</h4>
                        </div>
                        <!-- /.col-sm-6 -->
                            ...
                            <div id="primary" class="site-comtent">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <section class="section type2">
                                            <div class="subpage-title">
                                                <h5>Toggle Accordion + Contextual Alternatives</h5>
                                            </div>
                                            <div class="panel-group">
                                                ...
                                                <div class="panel panel-info">
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <a class="accordion-toggle collapsed" data-toggle="collapse" href="#collapseEight">
                                                Collapsible Group Item #04
                                                            </a>
                                                        </h4>
                                                    </div>
    ...
    JavaScript & jQuery 80%
                                    ...
                                    <div class="col-md-6">
                                        <section class="section type2">
                                            ...
                                            <ul class="nav nav-tabs" id="myTab">
                                                <li class="active"><a href="#home" data-toggle="tab">Tab Content #1</a></li>
                                                <li><a href="#profile" data-toggle="tab">Tab Content #2</a></li>
                                                <li><a href="#messages" data-toggle="tab">Tab Content #3</a></li>
                                            </ul>
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="home">
                                                    <p>Lorem ipsum dolor sit amet, ea vis legendos atomorum. Cu vix natum libris equidem, quo invenire tractatos eu, sit ex falli munere. Ex facer efficiantur vis, ut homero labitur facilisi duo, sed at clita iuvaret dolorem. Verterem perfecto maiestatis in sit, ad dicunt accumsan vel, vim corpora perpetua rationibus ex. Ei dicat adipiscing nam.</p>
                                                    <p>Eius vulputate at vis. Malorum praesent dissentiunt mei ad. Copiosae dissentiunt cu per.</p>
                                                </div>
                                                <div class="tab-pane" id="profile">
                                                    <p>Eius vulputate at vis. Malorum praesent dissentiunt mei ad. Copiosae dissentiunt cu per. Error impetus argumentum cu sed, ex appareat delicata gubergren pro, at ius erat dissentias. Tacimates interpretaris sit ex. Per debitis imperdiet ullamcorper ne, per et option corpora.</p>
                                                    <p>Eu ius mundi laoreet voluptatum, mei solum ridens fabellas ne, sit cu invenire praesent. Nam cu malis dissentiet dissentiunt, feugiat aliquando liberavisse ne quo.</p>
                                                </div>
                                                <div class="tab-pane" id="messages">
                                                    <p>Eu ius mundi laoreet voluptatum, mei solum ridens fabellas ne, sit cu invenire praesent. Nam cu malis dissentiet dissentiunt, feugiat aliquando liberavisse ne quo. Ea est eripuit prodesset, homero facilis est ne. Vel no audire cotidieque, id graece persius atomorum pro, cu cum choro libris consetetur. Nam velit vocent luptatum ei.</p>
                                                    <p>Posse harum dicit ea usu. Duo et probatus petentium, vis in porro perpetua instructior.</p>
                                                </div>
                                            </div>
                                        </section>
                                ...
                                <section class="section type2">
                                    ...
                                    <div class="alert alert-danger alert-dismissable">
                                        ...
                                        <p>
                                            ...
                                            <button type="button" class="btn btn-warning">Or do this</button>
                                        </p>
                                    </div>
                                </section>
                                            ...
                                            <div id="caroufredsel-testimonials-container">
                                                <div class="media testimonial">
                                                    <a class="pull-left" href="#">
                                                        <img class="media-object" src="img/users/img1.jpg" alt="..." width="75">
                                                    </a>
                                                    <div class="media-body">
                                                        <blockquote>
                                                            <p>Eius vulputate at vis. Malorum praesent dissentiunt mei ad. Copiosae dissentiunt cu per. Error impetus argumentum cu sed, ex appareat delicata gubergren pro, at ius erat dissentias. Tacimates interpretaris sit ex. Per debitis imperdiet ullamcorper ne, per et option corpora.</p>
                                                            <small>Bryon T. Kirkland / <cite title="Source Title">Twitter Inc.</cite></small>
                                                        </blockquote>
                                                    </div>
                                                </div>
                                                <div class="media testimonial">
                                                    <a class="pull-left" href="#">
                                                        <img class="media-object" src="img/users/img2.jpg" alt="..." width="75">
                                                    </a>
                                                    <div class="media-body">
                                                        <blockquote>
                                                            <p>Eius vulputate at vis. Malorum praesent dissentiunt mei ad. Copiosae dissentiunt cu per. Error impetus argumentum cu sed, ex appareat delicata gubergren pro, at ius erat dissentias. Tacimates interpretaris sit ex. Per debitis imperdiet ullamcorper ne, per et option corpora.</p>
                                                            <small>Kimberly J. Walters / <cite title="Source Title">Twitter Inc.</cite></small>
                                                        </blockquote>
                                                    </div>
                                                </div>
                                                <div class="media testimonial">
                                                    <a class="pull-left" href="#">
                                                        <img class="media-object" src="img/users/img3.jpg" alt="..." width="75">
                                                    </a>
                                                    <div class="media-body">
                                                        <blockquote>
                                                            <p>Eius vulputate at vis. Malorum praesent dissentiunt mei ad. Copiosae dissentiunt cu per. Error impetus argumentum cu sed, ex appareat delicata gubergren pro, at ius erat dissentias. Tacimates interpretaris sit ex. Per debitis imperdiet ullamcorper ne, per et option corpora.</p>
                                                            <small>Walter C. Cook / <cite title="Source Title">Twitter Inc.</cite></small>
                                                        </blockquote>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <section class="section type2">
                                    ...
                                    <div class="action-box">
                                        ...
                                        <a href="#" class="btn adv-color squre">Purchase Now</a>
                                    </div>
                                    <!-- /.action-box -->
                                </section>
                            </div>
