        ...
        <div id="page" class="hfeed site">
            ...
            <header class="archive-header">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <h4 class="archive-title">Buttons</h4>
                        </div>
                        <!-- /.col-sm-6 -->
            ...
            <div id="main" class="wrapper">
                <div id="primary" class="site-comtent">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="section type2 example-buttons">
                            ...
                            <div class="col-md-6">
                                <div class="section type2 example-buttons">
                                    <div class="subpage-title">
                                        <h5>Advanced Buttons</h5>
                                    </div>
                                    <button type="button" class="btn adv-default">Default Button</button>
                                    <button type="button" class="btn adv-primary">Primary Button</button>
                                    <button type="button" class="btn adv-success">Success Button</button>
                                    <button type="button" class="btn adv-info">Info Button</button>
                                    <button type="button" class="btn adv-warning">Warning Button</button>
                                    <button type="button" class="btn adv-danger">Danger Button</button>
                                    <button type="button" class="btn adv-inverse">Inverse Button</button>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="section type2 example-buttons">
                                    <div class="subpage-title">
                                        <h5>Advanced (Squre) Buttons</h5>
                                    </div>
                                    <button type="button" class="btn adv-default btn-squre">Default Button</button>
                                    <button type="button" class="btn adv-primary btn-squre">Primary Button</button>
                                    <button type="button" class="btn adv-success btn-squre">Success Button</button>
                                    <button type="button" class="btn adv-info btn-squre">Info Button</button>
                                    <button type="button" class="btn adv-warning btn-squre">Warning Button</button>
                                    <button type="button" class="btn adv-danger btn-squre">Danger Button</button>
                                    <button type="button" class="btn adv-inverse btn-squre">Inverse Button</button>
                            ...
                            <div class="col-md-6">
                                <div class="section type2 example-buttons">
                                    ...
                                    <button type="button" class="btn adv-default btn-lg">Large Button</button>
                                    <button type="button" class="btn adv-primary">Default Button</button>
                                    <button type="button" class="btn adv-success btn-sm">Small Button</button>
                                    <button type="button" class="btn adv-info btn-xs">Extra Small Button</button>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="section type2 example-buttons">
                                    <div class="subpage-title">
                                        <h5>Advanced (Bordered) Buttons</h5>
                                    </div>
                                    <button type="button" class="btn adv-default btn-bordered">Default Button</button>
                                    <button type="button" class="btn adv-primary btn-bordered">Primary Button</button>
                                    <button type="button" class="btn adv-success btn-bordered">Success Button</button>
                                    <button type="button" class="btn adv-info btn-bordered">Info Button</button>
                                    <button type="button" class="btn adv-warning btn-bordered">Warning Button</button>
                                    <button type="button" class="btn adv-danger btn-bordered">Danger Button</button>
                                    <button type="button" class="btn adv-inverse btn-bordered">Inverse Button</button>
