        ...
        <div id="page" class="hfeed site">
            ...
            <header class="archive-header">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <h4 class="archive-title">404 Error Page</h4>
                        </div>
                        <!-- /.col-sm-6 -->
                            ...
                            <div class="col-md-6">
                                <section class="section type2">
                                    <div class="error-content">
                                        ...
                                        <p class="lead">Please try to search to look for more information on this site.</p>
                                        <form class="search-form">
                                            <input type="text" class="form-control squre" placeholder="Search ...">
                                        </form>
                                        <a href="" class="btn adv-color squre">&laquo; &nbsp; Back to Home</a>
                                    </div>
                                    <!-- /.error-comtent -->
                                </section>
                            </div>
