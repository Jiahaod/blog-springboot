        ...
        <div id="page" class="hfeed site">
            ...
            <header class="archive-header">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <h4 class="archive-title">Blog: 2 Columns</h4>
                        </div>
                        <!-- /.col-sm-6 -->
                ...
                <div class="container">
                    <div id="primary" class="site-comtent">
                        <div class="row">
                            ...
                            <div class="col-md-6 article-wrap">
                                <article id="post-2" class="post type2">
                                    <div class="entry-thumb">
                                        <!-- 16:9 aspect ratio -->
                            ...
                            <div class="col-md-6 article-wrap">
                                <article id="post-3" class="post type2">
                                    <div class="entry-thumb">
                                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                ...
                                                <div class="item">
                                                    <img src="img/general/img6.jpg" alt="...">
                                                </div>
                                                <div class="item">
                                                    <img src="img/general/img7.jpg" alt="...">
                                                </div>
                                            </div>
                                            <!-- Controls -->
                            ...
                            <div class="col-md-6 article-wrap">
                                <article id="post-4" class="post type2">
                                    <div class="entry-thumb">
                                        <!-- 16:9 aspect ratio -->
                                        <div class="embed-responsive embed-responsive-10by8">
                            ...
                            <div class="col-md-6 article-wrap">
                                <article id="post-5" class="post type2">
                                    <div class="entry-wrap">
                                        <div class="entry-content">
                                            <blockquote>
                                                <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
                                                <p><small>Someone famous in <cite title="Source Title">Source Title</cite></small></p>
                                            </blockquote>
                                        </div>
                                        <!-- /.entry-content -->
                                        <div class="entry-meta">
                            ...
                            <div class="col-md-6 article-wrap">
                                <article id="post-6" class="post type2">
                                    <div class="entry-thumb">
                                        <img src="img/general/img3.jpg" class="img-responsive" alt="">
                                        <div class="image-overlay"></div>
                                        <a href="img/general/img3.jpg" data-rel="prettyPhoto" class="ima-zoom"><i class="fa fa-plus"></i></a>
                                    </div>
                                    <!-- /.entry-thumb -->
                                    <div class="entry-wrap">

                                        <header class="entry-header">
                                            <h1 class="entry-title"><a href="#" rel="bookmark">Eam ex putant omnesque explicari</a></h1>
                                        </header>
                                        <!-- /.entry-header -->
                                        <div class="entry-content">
                                            <p>Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus.</p>
                            ...
                            <div class="col-md-6 article-wrap">
                                <article id="post-7" class="post type2">
                                    <div class="entry-thumb">
                                        <!-- 16:9 aspect ratio -->
                                        <div class="embed-responsive embed-responsive-10by8">
                                            <iframe class="embed-responsive-item" src="//www.youtube.com/embed/98WtmW-lfeE"></iframe>
                                        </div>
                                    </div>
                                    <!-- /.entry-thumb -->
                                    <div class="entry-wrap">
                                        ...
                                        <header class="entry-header">
                                            <h1 class="entry-title"><a href="#" rel="bookmark">Nisl adipiscing instructior nam ea pri</a></h1>
                                        </header>
                                        <!-- /.entry-header -->
                                        <div class="entry-content">
                                            <p>Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus.</p>
                            ...
                            <div class="col-md-6 article-wrap">
                                <article id="post-8" class="post type2">
                                    <div class="entry-thumb">
                                        <div id="carousel-example-generic2" class="carousel slide" data-ride="carousel">
                                            <!-- Wrapper for slides -->
                                            <div class="carousel-inner">
                                                <div class="item active">
                                                    <img src="img/general/img4.jpg" alt="...">
                                                </div>
                                                <div class="item">
                                                    <img src="img/general/img8.jpg" alt="...">
                                                </div>
                                                <div class="item">
                                                    <img src="img/general/img9.jpg" alt="...">
                                                </div>
                                            </div>
                                            <!-- Controls -->
                                    ...
                                    <div class="entry-wrap">
                                        ...
                                        <header class="entry-header">
                                            <h1 class="entry-title"><a href="#" rel="bookmark">Duo omnesque molestie te no appetere convenire vim</a></h1>
                                        </header>
                                        <!-- /.entry-header -->
                                        <div class="entry-content">
                                            <p>Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus.</p>
                            ...
                            <div class="col-md-6 article-wrap">
                                <article id="post-9" class="post type2">
                                    <div class="entry-thumb">
                                        <img src="img/general/img5.jpg" class="img-responsive" alt="">
                                        <div class="image-overlay"></div>
                                        <a href="img/general/img5.jpg" data-rel="prettyPhoto" class="ima-zoom"><i class="fa fa-plus"></i></a>
                                    </div>
                                    <!-- /.entry-thumb -->
                                    <div class="entry-wrap">

                                        <header class="entry-header">
                                            <h1 class="entry-title"><a href="#" rel="bookmark">Per scaevola qualisque ne</a></h1>
                                        </header>
                                        <!-- /.entry-header -->
                                        <div class="entry-content">
                                            <p>Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus.</p>
